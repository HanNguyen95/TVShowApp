...
import com.hannguyen.tvshowapp.adapters.WatchlistAdapter;
import com.hannguyen.tvshowapp.databinding.ActivityWatchlistBinding;
import com.hannguyen.tvshowapp.listeners.WatchlistListener;
import com.hannguyen.tvshowapp.models.TVShow;
import com.hannguyen.tvshowapp.utilities.TempDataHolder;
import com.hannguyen.tvshowapp.viewmodels.WatchlistViewModel;
    ...
    public void removeTVShowFromWatchlist(TVShow tvShow, int position) {
        ...
        compositeDisposableForDelete.add(viewModel.removeTVShowFromWatchlist(tvShow)
                ...
                .subscribe(()->{
                    ...
                    watchlistAdapter.notifyItemMoved(position,watchlistAdapter.getItemCount());
                }));
    }
}